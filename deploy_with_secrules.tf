...
resource "azurerm_network_security_rule" "rule1a" {
  ...
  source_address_prefix = "*"
  source_port_range = "*"
  destination_address_prefixes= ["16.0.0.0/24"]
  destination_port_ranges = ["80","443"]
  protocol = "Tcp"
  resource_group_name= "${azurerm_resource_group.tera.name}"
}
...
resource "azurerm_network_security_rule" "rule2" {
  ...
  source_address_prefix = "*"
  destination_address_prefixes= ["13.0.2.0/24"]
  access= "Deny"
  priority= 100
  direction= "Outbound"
   resource_group_name= "${azurerm_resource_group.tera.name}"
...
resource "azurerm_network_security_rule" "rule2a" {
  ...
  destination_port_range = "*"
  source_address_prefix = "*"
  destination_address_prefixes= ["16.0.2.0/24"]
  access= "Deny"
  priority= 100
  direction= "Outbound"
   resource_group_name= "${azurerm_resource_group.tera.name}"
...
resource "azurerm_network_security_rule" "rule3" {
  ...
  source_address_prefixes = ["13.0.0.0/24"]
  destination_address_prefixes= ["13.0.1.0/24"]
  access= "Allow"
  priority= 110
  direction= "Outbound"
...
resource "azurerm_network_security_rule" "rule3a" {
  ...
  source_port_range = "*"
  destination_port_ranges = ["81","445"]
  source_address_prefixes = ["16.0.0.0/24"]
  destination_address_prefixes= ["16.0.1.0/24"]
  access= "Allow"
  priority= 110
  direction= "Outbound"
...
resource "azurerm_network_security_rule" "rule5" {
  ...
  destination_port_ranges = ["81","445"]
  source_address_prefixes = ["13.0.2.0/24"]
  destination_address_prefixes= ["13.0.1.0/24"]
  access= "Allow"
  priority= 110
  direction= "Inbound"
...
resource "azurerm_network_security_rule" "rule5a" {
  ...
  source_port_ranges = ["80","443"]
  destination_port_ranges = ["81","445"]
  source_address_prefixes = ["16.0.2.0/24"]
  destination_address_prefixes= ["16.0.1.0/24"]
  access= "Allow"
  priority= 110
  direction= "Inbound"
...
resource "azurerm_network_security_rule" "rule7" {
  ...
  source_address_prefixes = ["16.0.1.0/24"]
  destination_address_prefixes= ["16.0.2.0/24"]
  access= "Allow"
  priority= 100
  direction= "Outbound"
...
resource "azurerm_network_security_rule" "rule7a" {
  ...
  source_port_range ="*"
  destination_port_range = "3306"
  source_address_prefixes = ["13.0.1.0/24"]
  destination_address_prefixes= ["13.0.2.0/24"]
  access= "Allow"
  priority= 100
  direction= "Outbound"
